...
public class ApiDTO {
	...
	public void setEstbDd(int estbDd) {
		this.estbDd = estbDd;
	}
	...
	public int getGdrCnt() {
		return gdrCnt;
	}
	public void setGdrCnt(int gdrCnt) {
		this.gdrCnt = gdrCnt;
	}
	public int getIntnCnt() {
		return intnCnt;
	}
	public void setIntnCnt(int intnCnt) {
		this.intnCnt = intnCnt;
	}
	public int getResdntCnt() {
		return resdntCnt;
	}
	public void setResdntCnt(int resdntCnt) {
		this.resdntCnt = resdntCnt;
	}
	public int getSdrCnt() {
		return sdrCnt;
	}
